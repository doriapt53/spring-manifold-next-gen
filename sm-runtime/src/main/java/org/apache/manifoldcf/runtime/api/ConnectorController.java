...
public class ConnectorController {
    ...
    public ConnectorController() {
        // Initial mock data
        storage.add(new ConnectorDTO("FileSystem_Local", "Local File System", "repository", "org.apache.manifoldcf.crawler.connectors.filesystem.FileConnector", 10, new HashMap<>()));
        storage.add(new ConnectorDTO("Ollama_Output", "Ollama Vector Store", "output", "org.apache.manifoldcf.agents.output.ollama.OllamaOutputConnector", 10, new HashMap<>()));
    }
