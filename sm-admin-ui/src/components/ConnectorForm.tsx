...
export default function ConnectorForm() {
  ...
  const connectorClasses = {
    repository: [
      { label: 'File System', value: 'org.apache.manifoldcf.crawler.connectors.filesystem.FileConnector' },
      { label: 'Web Crawler', value: 'org.apache.manifoldcf.crawler.connectors.webcrawler.WebcrawlerConnector' },
      { label: 'Windows Share (JCIFS)', value: 'org.apache.manifoldcf.crawler.connectors.jcifs.JCIFSConnector' },
    ],
    output: [
      { label: 'Ollama Vector Store', value: 'org.apache.manifoldcf.agents.output.ollama.OllamaOutputConnector' },
      { label: 'Elasticsearch', value: 'org.apache.manifoldcf.agents.output.elasticsearch.ElasticsearchConnector' },
      { label: 'Apache Solr', value: 'org.apache.manifoldcf.agents.output.solr.SolrConnector' },
    ],
    authority: [
      { label: 'Active Directory', value: 'org.apache.manifoldcf.authorities.authorities.activedirectory.ActiveDirectoryAuthority' },
      { label: 'LDAP', value: 'org.apache.manifoldcf.authorities.authorities.ldap.LDAPAuthority' },
    ]
  }
